    ...
    <div>
      ...
      <form onSubmit={e => {
        ...
        <textarea 
          ...
          className="border-2 rounded border-gray-600 p-1"
        />
        <button type="submit" className="bg-blue-500 text-white rounded p-1">{exist ? "Update" : "Add +"}</button>
      </form>
          ...
          {notes.map(note => (
            <li key={note.id} className="border-b border-gray-600 p-2">
              <div className="flex justify-between">
                ...
                <button onClick={() => updateNote({title: note.title, content: note.content, id: note.id})} className="bg-blue-500 mr-3 px-3 text-white rounded">Update</button>
