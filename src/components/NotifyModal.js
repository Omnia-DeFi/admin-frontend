                ...
                <div className=" flex justify-center items-center ">
                    <div className=' w-[400px] flex gap-y-2 flex-col rounded-md p-5 bg-white'>
                        ...
                        <div className='gap-2 flex'>
                            <button onClick={()=> setIsOpen(false)} className='p-2 bg-red-500 rounded-md text-white'>Close</button>
                            <button onClick={sendNotification} className='p-2 bg-green-500 rounded-md text-white'>Send</button>
                        </div>
                    </div>
                </div>
            </div>
